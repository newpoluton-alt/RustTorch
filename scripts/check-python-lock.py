...
DOCUMENTATION_DEPENDENCIES = ['myst-nb==1.4.0', 'myst-parser==5.1.0', 'onnx==1.22.0', 'pyyaml==6.0.3', 'sphinx==9.1.0']
...
EXPECTED_DEPENDENCIES = {'cffi': [{'name': 'pycparser'}],
 ...
 'ipython': [{'marker': "sys_platform == 'win32'", 'name': 'colorama'},
             ...
             {'marker': "sys_platform != 'emscripten' and sys_platform != 'win32'",
              'name': 'pexpect'},
             {'name': 'prompt-toolkit'},
             {'marker': "sys_platform != 'cygwin' and sys_platform != 'emscripten'",
              'name': 'psutil'},
             {'name': 'pygments'},
             {'name': 'stack-data'},
             {'name': 'traitlets'}],
 ...
 'sqlalchemy': [{'marker': "platform_machine == 'AMD64' or platform_machine == 'WIN32' or "
                           "platform_machine == 'aarch64' or platform_machine == 'amd64' or "
                           "platform_machine == 'ppc64le' or platform_machine == 'win32' or "
                           "platform_machine == 'x86_64'",
                 'name': 'greenlet'},
                {'name': 'typing-extensions'}],
 'stack-data': [{'name': 'asttokens'}, {'name': 'executing'}, {'name': 'pure-eval'}],
 'sympy': [{'name': 'mpmath'}],
 'torch': [{'name': 'filelock'},
           {'name': 'fsspec'},
           {'name': 'jinja2'},
